...
| **WebAssembly (WASM)** | ❌ Not supported | — | See [WASM alternatives](https://github.com/kreuzberg-dev/html-to-markdown/tree/main/examples/visitor-pattern#wasm-visitor-pattern-workarounds) |
...
See [WASM README: Visitor Pattern Support](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/crates/html-to-markdown-wasm/README.md#visitor-pattern-support) for detailed alternatives and code examples.
...
> 4. **WASM Not Supported**: WebAssembly binding does not support visitor pattern. See [WASM alternatives](https://github.com/kreuzberg-dev/html-to-markdown/tree/main/examples/visitor-pattern#wasm-visitor-pattern-workarounds) above.
...
See: [`cdn-rewrite.py`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/cdn-rewrite.py), [`cdn-rewrite.ts`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/cdn-rewrite.ts), [`cdn-rewrite.rb`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/cdn-rewrite.rb), [`cdn-rewrite.php`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/cdn-rewrite.php)
...
See: [`content-filter.py`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/content-filter.py), [`content-filter.ts`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/content-filter.ts), [`content-filter.php`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/content-filter.php)
...
See: [`accessibility-check.py`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/accessibility-check.py)
...
See: [`async-validation.py`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/async-validation.py), [`async-validation.ts`](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/visitor-pattern/async-validation.ts)
...
- **[Metadata Extraction](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/metadata-extraction)** - Extract document metadata during conversion
- **[Performance Guide](https://github.com/kreuzberg-dev/html-to-markdown/blob/main/examples/performance)** - Benchmarking and optimization
